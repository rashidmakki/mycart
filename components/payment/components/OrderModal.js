      ...
      <View style={styles.bodyContent}>
        <View style={styles.row}>
          ...
          <View style={styles.descriptionColumn}>
            <OrderInformationDescriptionView description={`${FirstName} ${LastName}`}/>
            <AddressView address={`${AddressLine1} ${AddressLine2} ${City} ${CountryCode} ${Email} ${Phone} ${PostalCode}`} />
          </View>
        </View>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.descriptionColumn}>
            <OrderInformationDescriptionView description={`\u20B9 ${Amount}`} />
          </View>
        </View>
        <View style={styles.horizontalLine} />
